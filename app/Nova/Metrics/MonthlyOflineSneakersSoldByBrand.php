...
class MonthlyOflineSneakersSoldByBrand extends Partition
{
    public $name = 'Бренды офлайн заказов (за текущий месяц)';
    ...
    public function calculate(NovaRequest $request)
    {
        ...
        $query = Order::query()
            ...
            ->where('orders.is_online_order', false) // Фильтр для онлайн-заказов
            ->selectRaw("
                CASE
                    " . implode(" ", $cases) . "
                    ELSE 'Другие'
    ...
    {
        return 'monthly-ofline-sneakers-sold-by-brand';
    }
}
